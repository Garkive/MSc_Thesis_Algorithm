...
def import_and_process_data(file, file2):
    ...
    Dataset = pd.read_csv('C:\\Users\\João Moura\\Desktop\\HFVRP_Adapt\\HFVRP Benchmark\\' + file, sep=';', header=None, skiprows=1)
    ...
    VehicleInfo = pd.read_csv('C:\\Users\\João Moura\\Desktop\\HFVRP_Adapt\\HFVRP Benchmark\\' + file2 , sep=';', header=None)
